...
class ResUNet3D(TrainableLayer):
    """
    Implementation of 3D SR-Net
      Asma et al., "3D Shallow Residual Network", Multimedia Systems Journal.

      The major changes between this and standard 3d U-Net:
      * input size == output size: padded convs are used
      * single skip connection added as residual
    ...
    def __init__(self,
                 ...
                 acti_func='leakyrelu',
                 name='ResNoNewNet'):
        super(ResUNet3D, self).__init__(name=name)
